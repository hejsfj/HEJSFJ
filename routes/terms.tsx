                ...
                <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div class="w-full lg:shrink-0 ">
                    ...
                    <div class="flex flex-col relative mt-3 text-regular text-white sm:max-w-md lg:max-w-none font-body">
                      ...
                      <p className="mt-3">
                        Application means the software program provided by the Company downloaded by You on any electronic device, named HabitKit
                      ...
                      <p className="mt-3">
                        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SFJ Capital UG, Dhauner Straße 42, 67067 Ludwigshafen am Rhein, Germany.
                      ...
                      <p className="mt-3">
                        If you have any questions about these Terms and Conditions, You can contact us by email: hello@hejsfj.com
                      </p>
