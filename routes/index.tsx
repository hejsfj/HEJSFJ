        ...
        highlights: [
            {
                ...
                description: 'One of the first all-in-one messaging suites for SMBs in Germany.'
            },
    ...
    },
    {
        ...
        highlights: [
            {title: 'iOS & Android App.', description: 'Launched an iOS & Android App'},
            {
                ...
                description: 'Reached 200+ weekly active users and 5 star app store raiting.'
            },
        ...
        highlights: [
            {
                ...
                description: 'Explore my adventures and download those photos for whatever you make.'
            }],
...
<div className="w-full">
            ...
            <div className="w-full h-screen flex flex-col bg-black text-white justify-center bg-center bg-cover"
                 style={{
                    ...
                    <div className="mx-auto max-w-3xl">
                        ...
                        <div className="mx-auto">
                            <div className="mx-auto max-w-3xl lg:mx-0">
                                <p className="mt-2 text-4xl font-bold tracking-tight text-white sm:text-6xl">Sebastian
                                    Frederik Jacobsen</p>
            ...
            <div>
                {projects.map((project) => (
                    ...
                    <Project title={project.title} link={project.link} description={project.description}
                             backgroundImage={project.backgroundImage} highlights={project.highlights}
                             anchor={project.anchor} buttonText={project.buttonText}/>
