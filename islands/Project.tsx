...
export default function Project(props: ProjectProps) {
    ...
    return (
        <div id={props.anchor}
             className="w-full h-screen flex flex-col bg-black text-white justify-end bg-center bg-cover" style={{
            backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.0), rgba(0, 0, 0, 0.6)), url(${props.backgroundImage})`,
            height: '100vh'
        }}>
